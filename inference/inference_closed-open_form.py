...
def eval_model(args):
    ...
    # drop_last=False
    dataloader = DataLoader(dataset, sampler=sampler, batch_size=1,collate_fn=lambda x: x,)
    local_results = []
    ...
    for batch in tqdm(dataloader,position=0, file=sys.stdout):
        ...
        # metadata = {
        #     "location": question_info["metadata"]["location"][0],
        #     "modality": question_info["metadata"]["modality"][0],
        #     "answer_type": question_info["metadata"]["answer_type"][0],
        #     "base_type": question_info["metadata"]["base_type"][0],
        #     "content_type": question_info["metadata"]["content_type"][0],
        # }
